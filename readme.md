...
```bash
  git clone https://github.com/Rifat8080/hello-rails.git
```

You need to setup database for these project

```
  development = hello_rails_react_d2
  test        = hello_rails_react_t2
...
Feel free to check the [issues page](https://github.com/Rifat8080/hello-rails/issues).
